  ...
  <div class="app-container">
    <div>
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="运输公司名称" prop="companyName">
          <el-input
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['biz:transportCompany:add']"
            >新增</el-button
          >
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleImport"
            v-hasPermi="['biz:transportCompany:import']"
            >导入</el-button
          >
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['biz:transportCompany:export']"
            >导出</el-button
          >
        </el-col>
        <right-toolbar
        ...
        >
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['biz:transportCompany:edit']"
              >修改</el-button
            >
            <el-button
              size="mini"
              ...
              v-hasPermi="['biz:transportCompany:query']"
              >详情</el-button
            >
          </template>
        </el-table-column>
...
<script>
import {listCompany, delCompany,} from "@/api/organization/transportCompany";
...
export default {
  ...
  methods: {
    ...
    //   this.$modal
    //     .confirm('是否确认删除公司编号为"' + companyIds + '"的数据项？')
    //     .then(function () {
    ...
    handleExport() {
      this.download(
        "/biz/transportCompany/export",
        {
          ...this.queryParams,
        },
        `承运企业_${new Date().getTime()}.xlsx`
      );
    },
    /** 导入按钮操作 */
    handleImport() {
